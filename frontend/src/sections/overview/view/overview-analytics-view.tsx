            ...
            icon={
              <Box
                sx={{
                  ...
                  borderRadius: '50%',
                  background: (theme) =>
                    `linear-gradient(135deg, ${theme.palette.info.light} 0%, ${theme.palette.info.dark} 100%)`,
                }}
              >
                <Iconify
        ...
        <Grid size={{ xs: 12, sm: 6, md: 3 }}>
          <AnalyticsWidgetSummary
            ...
            icon={
              ...
              >
                <Iconify
                  icon={'mdi:bullseye-arrow' as any}
                  width={28}
                  sx={{ color: 'white' }}
                />
              </Box>
        ...
        <Grid size={{ xs: 12, md: 5 }} sx={{ display: 'flex' }}>
          <AnalyticsOrderTimeline
            ...
            list={[
              {
                id: '1',
                title: 'Wheat Planting - North Field',
                time: '2024-01-15',
                type: 'order1',
              },
              {
                id: '2',
                title: 'NPK Fertilization',
                time: '2024-02-10',
                type: 'order2',
              },
              {
            ...
            recommendations={[
              {
                ...
                description:
                  'Soil pH of 5.8 is below optimal. Apply 2 tons/ha of lime.',
                priority: 'high',
